...
export default function App({navigation}) {
  ...
  useEffect(() => {
    let soil = database.soil;
    let air = database.air;
    setVal1(soil);
    setVal2(air);
    setPercent1(soil[soil.length - 1]);
    setPercent2(air[air.length - 1]);
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.progressContainer}>
        <View style={styles.soilProgress}>
          ...
          <Text style={{color: `rgba(0,200,170,255)`, marginTop: 10}}>
            Soil moisture
          </Text>
        </View>
        <View style={styles.airProgress}>
          ...
          <Text style={{color: '#04d9ff', marginTop: 10}}>
            Atmosphere moisture
          </Text>
        </View>
      </View>
